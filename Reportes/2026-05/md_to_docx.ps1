...
$mdPath = Join-Path $baseDir 'Informe_Mensual_2026-05.md'
$htmlPath = Join-Path $baseDir 'Informe_Mensual_2026-05.html'
$docxPath = Join-Path $baseDir 'Informe_Mensual_2026-05.docx'
