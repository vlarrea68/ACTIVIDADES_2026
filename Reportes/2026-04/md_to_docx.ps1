...
$mdPath = Join-Path $baseDir 'Informe_Mensual_2026-04.md'
$htmlPath = Join-Path $baseDir 'Informe_Mensual_2026-04.html'
$docxPath = Join-Path $baseDir 'Informe_Mensual_2026-04.docx'
