...
$mdPath = Join-Path $baseDir 'Informe_Mensual_2026-06.md'
$htmlPath = Join-Path $baseDir 'Informe_Mensual_2026-06.html'
$docxPath = Join-Path $baseDir 'Informe_Mensual_2026-06.docx'
